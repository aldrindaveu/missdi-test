...
@section('title', 'View Talent - Adults')
          ...
          <div class="row">
            <div id="girlsadults">
              <div  id="kids-inner">
                <div class="kids-content">
                  <div class="buttonEme">
                      <center><a class="choiceLink" href="viewAdultsWoman"><h2>WOMEN</h2></a></center>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div id="boysadults">
              <div  id="kids-inner">
                <div class="kids-content">
                  <div class="buttonEme">
                      <center><a class="choiceLink" href="viewAdultsMan"><h2>MEN</h2></a></center>
                  </div>
                </div>
              </div>
            </div>
