...
@section('title', 'View Talent - Kids')
          ...
          <div class="row">
            <div id="girlskids">
              <div  id="kids-inner">
                <div class="kids-content">
                  <div class="buttonEme">
                      <center><a class="choiceLink" href="/viewKidsGirls"><h2>GIRLS</h2></a></center>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div id="boyskids">
              <div  id="kids-inner">
                <div class="kids-content">
                  <div class="buttonEme">
                      <center><a class="choiceLink" href="/viewKidsBoys"><h2>BOYS</h2></a></center>
                  </div>
                </div>
              </div>
            </div>
