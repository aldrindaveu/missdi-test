            ...
            <div class="widget-user-header widgetuserheader">
              <div class="row">
                ...
                <div class="col-md-10">
                  ...
                  <h5 class="widget-user-desc widgetuserdesc">Member since @if (isset(Auth::user()->username)) {{ \Carbon\Carbon::parse(Auth::user()->created_at)->format('M d, Y')}} @endif  &nbsp | &nbsp Customer</h5>
                  <h5 class="widget-user-desc widgetuserdesc"><a href="#" role="button">  Edit Profile </a></h5>
               </div>
              </div>
                            ...
                            <div class="panel-body">
                              <div class="row">
                                <div style="float:left; width:50%; text-align: center">
                                  Head Shot: <input type="file" class="btn btn-black">
                                </div>
                                <div style="float:right; width:50%; text-align: center">
                                  Full Body Shot: <input type="file" class="btn btn-black">
                                </div>
                              </div><br><br><br>
